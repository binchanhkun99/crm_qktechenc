      ...
      <a-form :model="formState" layout="vertical" @submit.prevent="handleSubmit">
        <a-row :gutter="16">
          ...
          <a-form-item label="Ảnh tin tức">
            ...
            >
              <img v-if="formState.image" :src="formState.image" alt="ImgNews" style="width: 100%" />
              <div v-else>
                <PlusOutlined />
...
import { VBtn } from 'vuetify/components'
  ...
  const columns: TableColumnsType = [
    ...
    { title: 'Tháng', dataIndex: 'month', key: 'month', width: 200 },
    { title: 'Ảnh', dataIndex: 'image', key: 'image', width: 200 },
    { title: 'Trích đoạn', dataIndex: 'exceprt', key: 'exceprt', width: 200 },
